...
function ChatMessages({
    ...
    useChatScroll({
        ...
        shouldLoadMode: !isFetchingNextPage && !!hasNextPage,
                ...
                <div className="flex justify-center">
                    {isFetchingNextPage ? (
                        ...
                        <button
                            ...
                            className="text-zinc-500 hover:text-zinc-600 dark:text-zinc-300 text-xs my-4 dark:hover:text-zinc-300 transition"
                        >
